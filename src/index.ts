...
const libro2 = new Libros ("pricipito","antoine de saint","fitcion","español",89,"tapadura",97819864314480,"un cuento magico que sigue las aventuras de un pequeño principe","nuevo","francia","1994","boka for you young",96,"11.43*3.18*18.42","100g",true);
